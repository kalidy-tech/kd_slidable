...
import 'package:kd_slidable/src/action_pane_motions.dart';
import 'package:kd_slidable/src/actions.dart';
import 'package:kd_slidable/src/slidable.dart';
...
void main() {
        ...
        Directionality(
          ...
          child: Slidable(
            startActionPane: ActionPane(
              ...
              children: [
                SlidableAction(
                    onPressed: (_) {}, widget: const Icon(Icons.share)),
                SlidableAction(
                    onPressed: (_) {}, widget: const Icon(Icons.delete)),
              ],
            ),
  ...
  testWidgets(
    ...
    final actionPane = ActionPane(
      ...
      motion: const BehindMotion(),
      children: [
        SlidableAction(onPressed: (_) {}, widget: const Icon(Icons.share)),
        SlidableAction(onPressed: (_) {}, widget: const Icon(Icons.delete)),
      ],
    );
